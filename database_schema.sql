...
-- ===================================================================
-- 4. ТАБЛИЦА: Транспортные средства
-- ===================================================================
CREATE TABLE vehicles (
    vehicle_id SERIAL PRIMARY KEY,
    license_plate VARCHAR(20) UNIQUE NOT NULL,
    vehicle_type VARCHAR(50) NOT NULL, -- Car, Van, Truck, etc.
...
-- ===================================================================
-- 8. ТАБЛИЦА: Партии доставки (Shipments)
-- ===================================================================
CREATE TABLE shipments (
    ...
    status VARCHAR(50) NOT NULL DEFAULT 'Pending', -- Pending, In Transit, Delivered, Delayed, Failed
...
-- ===================================================================
-- 9. ТАБЛИЦА: Доставки (детальная информация)
-- ===================================================================
CREATE TABLE deliveries (
    ...
    delivery_notes TEXT,
    status VARCHAR(50) NOT NULL DEFAULT 'Pending', -- Pending, In Transit, Delivered, Failed, Reattempt
...
-- Статистика по заказам и поставкам
